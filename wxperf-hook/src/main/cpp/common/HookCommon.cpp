...
Java_com_tencent_wxperf_jni_HookManager_xhookEnableDebugNative(JNIEnv *env, jobject thiz,
                                                                      jboolean flag) {
    xhook_enable_debug(flag);
}

JNIEXPORT void JNICALL
Java_com_tencent_wxperf_jni_HookManager_xhookEnableSigSegvProtectionNative(JNIEnv *env,
                                                                                  jobject thiz,
                                                                                  jboolean flag) {
...
JNIEXPORT void JNICALL
Java_com_tencent_wxperf_jni_HookManager_xhookClearNative(JNIEnv *env, jobject thiz) {
    xhook_clear();
}

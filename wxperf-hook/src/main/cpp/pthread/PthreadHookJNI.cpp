...
Java_com_tencent_wxperf_jni_pthread_PthreadHook_addHookSoNative(JNIEnv *env, jobject thiz,
...
JNIEXPORT void JNICALL
Java_com_tencent_wxperf_jni_pthread_PthreadHook_addIgnoreSoNative(JNIEnv *env, jobject thiz,
                                                                          jobjectArray hook_so_list) {
    jsize size = env->GetArrayLength(hook_so_list);
...
JNIEXPORT void JNICALL
Java_com_tencent_wxperf_jni_pthread_PthreadHook_addHookThreadNameNative(JNIEnv *env,
                                                                                jobject thiz,
...
JNIEXPORT void JNICALL
Java_com_tencent_wxperf_jni_pthread_PthreadHook_dumpNative(JNIEnv *env, jobject thiz,
                                                                   jstring jpath) {
    if (jpath) {

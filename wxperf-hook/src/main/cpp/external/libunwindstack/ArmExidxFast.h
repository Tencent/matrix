...
#ifndef _LIBUNWINDSTACK_ARM_EXIDX_FAST_H
#define _LIBUNWINDSTACK_ARM_EXIDX_FAST_H
...
class ArmExidxFast {
 public:
    ArmExidxFast(uintptr_t* regs, Memory* elf_memory, Memory* process_memory)
      : regs_(regs), elf_memory_(elf_memory), process_memory_(process_memory) {}
  virtual ~ArmExidxFast() {}
...
#endif  // _LIBUNWINDSTACK_ARM_EXIDX_FAST_H

...
#ifndef _LIBWECHATBACKTRACE_DWARF_CFA_H
#define _LIBWECHATBACKTRACE_DWARF_CFA_H
...
#include <include/unwindstack/DwarfLocation.h>
#include <include/unwindstack/DwarfStructs.h>
#include <include/unwindstack/DwarfMemory.h>
#include <Errors.h>
...
class DwarfCfa {
 ...
 public:
  DwarfCfa(unwindstack::DwarfMemory* memory, const unwindstack::DwarfFde* fde) : memory_(memory), fde_(fde) {}
  ...
  void set_cie_loc_regs(const unwindstack::dwarf_loc_regs_t* cie_loc_regs) { cie_loc_regs_ = cie_loc_regs; }
 ...
 private:
  ...
  const unwindstack::DwarfFde* fde_;

  AddressType cur_pc_;
  const unwindstack::dwarf_loc_regs_t* cie_loc_regs_ = nullptr;
  std::vector<AddressType> operands_;
  std::stack<unwindstack::dwarf_loc_regs_t> loc_reg_state_;

  // CFA processing functions.
  bool cfa_nop(unwindstack::dwarf_loc_regs_t*);
  bool cfa_set_loc(unwindstack::dwarf_loc_regs_t*);
  bool cfa_advance_loc(unwindstack::dwarf_loc_regs_t*);
  bool cfa_offset(unwindstack::dwarf_loc_regs_t*);
  bool cfa_restore(unwindstack::dwarf_loc_regs_t*);
  bool cfa_undefined(unwindstack::dwarf_loc_regs_t*);
  bool cfa_same_value(unwindstack::dwarf_loc_regs_t*);
  bool cfa_register(unwindstack::dwarf_loc_regs_t*);
  bool cfa_remember_state(unwindstack::dwarf_loc_regs_t*);
  bool cfa_restore_state(unwindstack::dwarf_loc_regs_t*);
  bool cfa_def_cfa(unwindstack::dwarf_loc_regs_t*);
  bool cfa_def_cfa_register(unwindstack::dwarf_loc_regs_t*);
  bool cfa_def_cfa_offset(unwindstack::dwarf_loc_regs_t*);
  bool cfa_def_cfa_expression(unwindstack::dwarf_loc_regs_t*);
  bool cfa_expression(unwindstack::dwarf_loc_regs_t*);
  bool cfa_offset_extended_sf(unwindstack::dwarf_loc_regs_t*);
  bool cfa_def_cfa_sf(unwindstack::dwarf_loc_regs_t*);
  bool cfa_def_cfa_offset_sf(unwindstack::dwarf_loc_regs_t*);
  bool cfa_val_offset(unwindstack::dwarf_loc_regs_t*);
  bool cfa_val_offset_sf(unwindstack::dwarf_loc_regs_t*);
  bool cfa_val_expression(unwindstack::dwarf_loc_regs_t*);
  bool cfa_gnu_negative_offset_extended(unwindstack::dwarf_loc_regs_t*);

  using process_func = bool (DwarfCfa::*)(unwindstack::dwarf_loc_regs_t*);
...
#endif  // _LIBWECHATBACKTRACE_DWARF_CFA_H

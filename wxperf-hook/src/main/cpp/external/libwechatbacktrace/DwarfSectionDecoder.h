...
public:
    ...
    virtual bool GetCfaLocationInfo(uint64_t pc, const unwindstack::DwarfFde* fde, unwindstack::dwarf_loc_regs_t* loc_regs);
...
protected:
    ...
    bool EvalRegister(const unwindstack::DwarfLocation* loc, uint16_t regs_total, uint32_t reg,
            void* info);
    bool EvalExpression(const unwindstack::DwarfLocation& loc, unwindstack::Memory* regular_memory,

 ...
 * library 28.0.0-alpha1. Some changes was made for adapting Matrix's specific usage.
 *
...
public abstract class MatrixJobIntentService extends Service {
    static final String TAG = "Matrix.JobIntentService";
    ...
    /**
     * Implementation of a JobServiceEngine for interaction with MatrixJobIntentService.
     */
    @RequiresApi(26)
    ...
    /**
     * Call this to enqueue work for your subclass of {@link MatrixJobIntentService}.  This will

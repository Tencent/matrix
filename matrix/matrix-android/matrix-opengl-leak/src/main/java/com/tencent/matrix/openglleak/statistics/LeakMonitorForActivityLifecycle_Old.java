...
@Deprecated
public class LeakMonitorForActivityLifecycle_Old extends CustomizeLeakMonitor implements Application.ActivityLifecycleCallbacks {

    private static final String TAG = "matrix.GPU_LeakMonitor";
    private static LeakMonitorForActivityLifecycle_Old mInstance = new LeakMonitorForActivityLifecycle_Old();

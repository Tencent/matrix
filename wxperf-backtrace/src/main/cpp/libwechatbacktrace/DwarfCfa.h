...
// See section 6.4.2.1 for a description of the DW_CFA_xxx values.
    ...
    public:
        DwarfCfa(unwindstack::DwarfMemory *memory, const unwindstack::DwarfFde *fde) : memory_(
                memory), fde_(fde) {}
        ...
        void set_cie_loc_regs(
                const unwindstack::dwarf_loc_regs_t *cie_loc_regs) { cie_loc_regs_ = cie_loc_regs; }

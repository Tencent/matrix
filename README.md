...
* **Install via Cocoapods**
  ...
  3. In your Podfile, add `pod 'matrix-apple'` to your app target, from the command line, run `pod install`;
...
* **通过 Cocoapods 安装**
  ...
  3. 在 Podfile 对应的 target 中，添加 pod 'matrix-apple'，并执行 pod install；

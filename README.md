...
**Matrix** is an Application Performance Management (APM) tool used by WeChat to locate, analyse and monitor performance problems. As a **plugin-like**, **non-invasive** solution, Matrix is currently available on iOS, macOS and Android platforms.
